...
The revised [VisDrone Dataset](https://pan.baidu.com/s/1G30vw2NO3WvHO5Q2EViI6g) can be downloaded from Baidu Netdisk. 
...
val script 
```sh
python main.py --model_cfg "cfg/dssm-s.yaml" --dataset_path "dataset_path" --test_only True --resume "weight_path"
```
